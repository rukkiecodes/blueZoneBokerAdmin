        ...
        <v-row justify="space-between">
            <v-col cols="12" md="5">
                ...
                <v-card class="rounded-lg" flat>
                    ...
                    <v-card-title v-if="user?.investment != undefined"
                    ...
                    <v-card-title v-if="user?.earnings != undefined"
                        class="d-flex justify-space-between align-center pt-0">
            ...
            <v-col cols="12" md="7">
                ...
                <v-card height="80vh" flat class="d-flex flex-column justify-space-between rounded-lg">
                    <div class="pa-4 overflow-auto chatSheet">
                        ...
                        " style="width: 100%">
                            <v-card min-width="4" max-width="70%" :class="
                                chat.user == admin
...
export default {
    ...
    methods: {
        ...
        async getChat() {
            const unsub = onSnapshot(query(collection(db, 'support', this.$route.params.id, 'messages'), orderBy('timestamp', 'asc')),
                snapshot => {
                    this.chats = []
